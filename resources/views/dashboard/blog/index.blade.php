...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">A list of all the Blogs which includes Title, Description and Image</p>
      </div>
          ...
          <table class="min-w-full divide-y divide-gray-300">
            ...
            @foreach ($blogs as $key=>$blog)
              <tr>
                 ...
                 <td class="whitespace-wrap px-3 py-4 text-sm text-gray-500">{{ $blog->description }}</td>
                <td class="whitespace-wrap px-3 py-4 text-sm text-gray-500">
                    <img src={{ $blog->image }} alt="Blog Image">
                </td>
                <td class="relative whitespace-wrap py-4 pl-3 text-sm sm:pr-0" >
                  <div class="flex gap-5 items-center pr-4">
